...
void setup()
{
  ...
  //  initialise le port serie et le baud rate à 9600
...
void mouseReleased()
{
  switch(mae) {
    ...
    case RECHERCHE:
      ...
      if (mouseX >= width/20 && mouseY >= 5 + 3*height/10 && mouseX <= 14*width/20 + width/20 && mouseY <= 3*height/20 + 5 + 3*height/10){
        mae = machineEtat.PROFIL;
      }
    break;
    case BULLETIN:
...
void draw_recherche(){
      ...
      // Au tableau élève 1 
      fill(90,238,211);
      rect(14*width/20, 1.75*height/5, 4.5*width/20, height/10);
      fill(255);
      text("AU", 15.2*width/20, 1.6*height/5, 10*width/20, height/10);
      fill(255);
      text("TABLEAU", 14*width/20, 1.80*height/5, 5*width/20, height/10);
      
      //Au tableau élève 2 
      fill(90,238,211);
      rect(14*width/20, 2.60*height/5, 4.5*width/20, 0.90*height/10);
      fill(255);
      text("AU", 15.2*width/20, 2.45*height/5, 10*width/20, height/10);
      fill(255);
      text("TABLEAU", 14*width/20, 2.65*height/5, 5*width/20, height/10);
      
      if (mouseX >= 14*width/20 && mouseY >= 1.75*height/5 && mouseX <= 14*width/20 + 4.5*width/20 && mouseY <= 1.75*height/5 + height/10){
       // mae = machineEtat.PROFIL;
